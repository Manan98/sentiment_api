...
FILE_DOWN_LOAD_SERVICE = "/api/file/download/"

@sentiment_file_api.route('/api/file/upload', methods=['POST'])
def upload_file():
...
@sentiment_file_api.route('/api/file/all', methods=['GET'])
...
@sentiment_file_api.route('/api/file/download/<filename>', methods=['GET'])
